// Historical ONNX baseline; production uses the GGUF engine.
import config from './onnxBaselineConfig.json';
import { LogitsProcessor, LogitsProcessorList, Tensor, type TextGenerationPipeline } from '@huggingface/transformers';
import { categoryToken, type LocalInput } from './localModelContract';
