...
الافتراضي الآن **نموذج Qwen3‑0.6B محلي مجاني داخل المتصفح**، دون حساب مزوّد أو مفتاح API.
...
التنزيل الأول يقارب 950 ميغابايت ويتطلب متصفحًا حديثًا وذاكرة متاحة. عند تعذره أو إلغائه
...
راجع [دليل الاستخدام وحدود النموذج والاختبار والتوثيق البحثي](docs/LLM_INTEGRATION_AR.md).
