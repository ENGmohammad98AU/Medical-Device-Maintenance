...
- نموذج لغوي محلي بلا مفتاح لاقتراح فئة العطل مع قواعد سلامة ومراجعة بشرية / No-key browser LLM category suggestions with server safety rules
...
يقترح فئة العطل فقط، وتبقى الخطورة وإجراءات الصيانة من قواعد الخادم والمراجع.
